...
const Footer = () => {
    return (
        <div className="px-8 md:px-10 lg:px-50 pt-20 md:pt-30 bg-[#101727] text-white text-center">
            <div className="grid grid-cols-1 space-y-3 md:space-y-0 md:grid-cols-5 pb-20">
                ...
                <ul className="text-[#A1A1AA] space-y-1 md:space-y-4">
                ...
                <div className="space-y-2 md:space-y-4 mt-10 md:mt-0">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center text-[#7f7f8d]">
